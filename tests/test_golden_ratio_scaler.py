...
def test_calculate_ltv_cac_ratio(
    scaler, conversions, total_spend_micros, avg_ltv, expected_ratio
):
    assert (
        scaler.calculate_ltv_cac_ratio(conversions, total_spend_micros, avg_ltv)
        == expected_ratio
    )
