...
def generate_polarity_ads(persona: PersonaSchema, config: CampaignConfiguration, max_retries: int = 3) -> List[AdVariation]:
    """
    ...
    """
    template_path = Path(__file__).parent.parent.parent / "prompts" / "setup" / "generate_polarity_ads.yaml"
