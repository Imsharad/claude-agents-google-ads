...
def get_google_ads_client(config_file: str = "google-ads.yaml"):
    ...
    """
    try:
        logging.info(f"Attempting to load Google Ads configuration from '{config_file}'")
        ...
        logging.error(f"An unexpected error occurred while initializing the Google Ads client: {e}")
        return None
